...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `sessions_BEFORE_INSERT` BEFORE INSERT ON `sessions` FOR EACH ROW BEGIN
 set new.SessionID = (select uuid());
END */;;
DELIMITER ;
